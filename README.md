...
### 🛠️ Core Professional Tech Stack

| Category | Technologies & Frameworks |
| :--- | :--- |
| **Frontend Languages** | HTML5, CSS3, JavaScript (ES6+) |
| **Backend Frameworks** | PHP Core, CodeIgniter Fundamentals |
| **Database & BaaS** | Supabase (PostgreSQL), MariaDB, MySQL CRUD |
| **Methodologies** | Agile SDLC Lifecycle, Systems Documentation |
